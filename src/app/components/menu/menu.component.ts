...
export class MenuComponent implements OnInit {
  ...
  platos: Plato[] = [
...

    {
      ...
      precio2: '',
      img: '../../../assets/menu/min/burrata-min.png',
...

    {
      ...
      precio2_visible: 'none',
      precio2: '',
      img: '../../../assets/menu/min/provolone-min.png',
      categorias: ['completo', 'entrantes'],
      clase: 'reverse',
      sugerencia: 'none',
      nuevo: 'true',
...

    {
      ...
      precio2_visible: 'none',
      precio2: '',
      img: '../../../assets/menu/min/patatas-min.png',
      categorias: ['completo', 'entrantes'],
      clase: '',
      sugerencia: 'none',
      nuevo: '',
...

    {
      ...
      precio2_visible: 'block',
      precio2: 'Triple 11,5',
      img: '../../../assets/menu/min/burgerbbq-min.png',
      categorias: ['completo', 'hamburguesas'],
      clase: 'reverse',
      sugerencia: 'flex',
      nuevo: 'true',
...

    {
      ...
      precio2_visible: 'none',
      precio2: '',
      img: '../../../assets/menu/min/coulantchoco-min.png',
      categorias: ['completo', 'postres'],
      clase: '',
      sugerencia: 'none',
      nuevo: '',
...

    {
      ...
      precio2_visible: 'none',
      precio2: '',
      img: '../../../assets/menu/min/coulantcara-min.png',
      categorias: ['completo', 'postres'],
      clase: 'reverse',
      sugerencia: 'none',
      nuevo: '',
...

    {
      ...
      precio2_visible: 'none',
      precio2: '',
      img: '../../../assets/menu/min/coulantqueso-min.png',
      categorias: ['completo', 'postres'],
      clase: '',
      sugerencia: 'none',
      nuevo: '',
